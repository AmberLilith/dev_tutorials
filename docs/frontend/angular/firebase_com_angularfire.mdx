...
![Confirmar iniciar Firebase](./img/firebase_com_angularfire/1.png)

Em seguida será questionada qual conta google deseja usar para se conectar ao Firebase:

![Confirmar iniciar Firebase](./img/firebase_com_angularfire/2.png)

Depois qual projeto:

![Confirmar iniciar Firebase](./img/firebase_com_angularfire/3.png)

Depois qual hosting:

![Confirmar iniciar Firebase](./img/firebase_com_angularfire/4.png)

Em seguida escolher qual app:

![Confirmar iniciar Firebase](./img/firebase_com_angularfire/5.png)

Ao final, a própria biblioteca AngulaFire vai adicionar a dependencia abaixo no seu arquivo app.module.ts:

![Confirmar iniciar Firebase](./img/firebase_com_angularfire/6.png)
...
![Confirmar iniciar Firebase](.//img/firebase_com_angularfire/13.png)

Vá no arquivo ```node_modules\@angular\fire\compat\database\interfaces.d.ts``` e substitua as linhas conforme abaixo:

![Confirmar iniciar Firebase](.//img/firebase_com_angularfire/14.png)
